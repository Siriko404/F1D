# Verify §2.2-2.5 all verbatim substrings of the .tex + dash-free; 2.3 no bare DWZ. Fail-closed.
import json
...
for k in ["P1","P2","P3"]:
    assert "DWZ" not in d3["paragraphs"][k]["final_prose"], f"2.3 {k} bare DWZ"
print("VERIFIED: 2.2 + 2.3 + 2.4(fixed) + 2.5 all verbatim in .tex; dash-free; 2.3 no bare DWZ.")
