...
"""
================================================================================
STEP 5.8: H9 Final Merge and Regression
================================================================================
ID: 5.8_H9_FinalMerge
...
Inputs:
    - 4_Outputs/5.8_H9_StyleFrozen/latest/style_frozen.parquet (CEO style)
    - 4_Outputs/5.8_H9_PRiskFY/latest/priskfy.parquet (fiscal-year PRisk)
    - 4_Outputs/5.8_H9_AbnormalInvestment/latest/abnormal_investment.parquet (DV + controls)
...
def setup_paths(timestamp):
    ...
    paths = {
        "root": root,
        "style_frozen_base": root / "4_Outputs" / "5.8_H9_StyleFrozen",
        "priskfy_base": root / "4_Outputs" / "5.8_H9_PRiskFY",
        "abnormal_inv_base": root / "4_Outputs" / "5.8_H9_AbnormalInvestment",
    }

    # Output directory
    output_base = root / "4_Outputs" / "5.8_H9_FinalMerge"
    paths["output_dir"] = output_base / timestamp
    ensure_output_dir(paths["output_dir"])

    # Log directory
    log_base = root / "3_Logs" / "5_Financial_V3" / "5.8_H9_FinalMerge"
...
def load_style_frozen(style_frozen_base):
    ...
    Args:
        style_frozen_base: Base path to 5.8_H9_StyleFrozen output
...
def load_priskfy(priskfy_base):
    ...
    Args:
        priskfy_base: Base path to 5.8_H9_PRiskFY output
...
def load_abnormal_investment(abnormal_inv_base):
    ...
    Args:
        abnormal_inv_base: Base path to 5.8_H9_AbnormalInvestment output
...
"""
    ...
    report_lines = [
        ...
        "---",
        "",
        "*Generated by 5.8_H9_FinalMerge.py*",
    ]
...
Examples:
  ...
  python 5.8_H9_FinalMerge.py

  # Dry run (load data, skip regression)
  python 5.8_H9_FinalMerge.py --dry-run
