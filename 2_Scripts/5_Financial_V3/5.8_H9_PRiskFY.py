...
"""
================================================================================
STEP 5.8: H9 PRisk x CEO Style -> Abnormal Investment (PRiskFY Construction)
================================================================================
ID: 5.8_H9_PRiskFY
...
Outputs:
    ...
    - 3_Logs/5_Financial_V3/5.8_H9_PRiskFY/{timestamp}_priskfy.log
...
def setup_paths(config, timestamp):
    ...
    # Output directory
    output_base = root / "4_Outputs" / "5.8_H9_PRiskFY"
    paths["output_dir"] = output_base / timestamp
    ensure_output_dir(paths["output_dir"])

    # Log directory
    log_base = root / "3_Logs" / "5_Financial_V3" / "5.8_H9_PRiskFY"
...
def generate_report(stats, output_dir):
    ...
    """
    report_path = output_dir / "report_step58_02.md"
...
3. **report_step58_02.md** - This report
...
- StyleFrozen (from 58-01): CEO communication style at firm-year level
- AbsAbInv + Controls (from 58-03): Biddle abnormal investment measures
...
def main():
    ...
    if args.dry_run:
        print("=" * 60)
        print("STEP 5.8: H9 PRiskFY Construction - DRY RUN")
    ...
    print("=" * 60)
    print("STEP 5.8: H9 PRiskFY Construction")
    print(f"Timestamp: {timestamp}")
    print("=" * 60)
