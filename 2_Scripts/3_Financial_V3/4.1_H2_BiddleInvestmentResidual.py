...
"""
================================================================================
STEP 4.1: H2 Biddle (2009) Investment Residual (V3 - PRisk Interaction)
================================================================================
ID: 4.1_H2_BiddleInvestmentResidual
...
Outputs:
    - 4_Outputs/3_Financial_V3/4.1_H2_BiddleInvestmentResidual/{timestamp}/H2_InvestmentResiduals.parquet
    - 4_Outputs/3_Financial_V3/4.1_H2_BiddleInvestmentResidual/{timestamp}/stats.json
    - 3_Logs/3_Financial_V3/4.1_H2_BiddleInvestmentResidual/{timestamp}_Biddle.log
...
def parse_arguments():
    """Parse command-line arguments for 4.1_H2_BiddleInvestmentResidual.py."""
    parser = argparse.ArgumentParser(
        description="""
STEP 4.1: H2 Biddle (2009) Investment Residual
...
def main():
    ...
    if args.dry_run:
        print("=" * 60)
        print("STEP 4.1: H2 Biddle Investment Residual - DRY RUN")
    ...
    print("=" * 60)
    print("STEP 4.1: H2 Biddle (2009) Investment Residual")
    print(f"Timestamp: {timestamp}")
    print("=" * 60)
    ...
    stats = {
        "step_id": "4.1_H2_BiddleInvestmentResidual",
        "timestamp": timestamp,
