"""Builder for Manager Presentation Positive Sentiment variable.

Loads Manager_Pres_Positive_pct from Stage 2 linguistic variables output.
"""
...
class ManagerPresPositiveBuilder(VariableBuilder):
    """Build Manager Presentation Positive Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Manager_Pres_Positive_pct")
...
__all__ = ["ManagerPresPositiveBuilder"]
