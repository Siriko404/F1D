"""Builder for CEO Presentation Weak Modal variable.

Loads CEO_Pres_Weak_Modal_pct from Stage 2 linguistic variables output.
"""
...
class CEOPresWeakModalBuilder(VariableBuilder):
    """Build CEO Presentation Weak Modal variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "CEO_Pres_Weak_Modal_pct")
...
__all__ = ["CEOPresWeakModalBuilder"]
