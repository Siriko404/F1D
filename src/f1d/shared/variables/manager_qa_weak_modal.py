"""Builder for Manager Q&A Weak Modal variable.

Loads Manager_QA_Weak_Modal_pct from Stage 2 linguistic variables output.
"""
...
class ManagerQAWeakModalBuilder(VariableBuilder):
    """Build Manager Q&A Weak Modal variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Manager_QA_Weak_Modal_pct")
...
__all__ = ["ManagerQAWeakModalBuilder"]
