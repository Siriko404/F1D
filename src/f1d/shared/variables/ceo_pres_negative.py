...
Loads CEO_Pres_Negative_pct from Stage 2 linguistic variables output.
"""
...
class CEOPresNegativeBuilder(VariableBuilder):
    """Build CEO Presentation Negative Sentiment variable from Stage 2 outputs.
...
__all__ = ["CEOPresNegativeBuilder"]
