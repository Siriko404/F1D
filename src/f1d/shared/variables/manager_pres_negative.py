"""Builder for Manager Presentation Negative Sentiment variable.

Loads Manager_Pres_Negative_pct from Stage 2 linguistic variables output.
"""
...
class ManagerPresNegativeBuilder(VariableBuilder):
    """Build Manager Presentation Negative Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Manager_Pres_Negative_pct")
...
__all__ = ["ManagerPresNegativeBuilder"]
