"""Builder for CEO Q&A Positive Sentiment variable.

Loads CEO_QA_Positive_pct from Stage 2 linguistic variables output.
"""
...
class CEOQAPositiveBuilder(VariableBuilder):
    """Build CEO Q&A Positive Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "CEO_QA_Positive_pct")
