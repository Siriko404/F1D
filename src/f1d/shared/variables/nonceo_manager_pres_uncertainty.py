"""Builder for Non-CEO Manager Presentation Uncertainty variable.

Loads NonCEO_Manager_Pres_Uncertainty_pct from Stage 2 linguistic variables output.
"""
...
class NonCEOManagerPresUncertaintyBuilder(VariableBuilder):
    """Build Non-CEO Manager Presentation Uncertainty variable from Stage 2 outputs.

    Source: outputs/2_Textual_Analysis/2.2_Variables/latest/
    File: linguistic_variables_{year}.parquet
    Column: NonCEO_Manager_Pres_Uncertainty_pct
    """

    def __init__(self, config: Dict[str, Any]):
        super().__init__(config)
        self.column = config.get("column", "NonCEO_Manager_Pres_Uncertainty_pct")
...
__all__ = ["NonCEOManagerPresUncertaintyBuilder"]
