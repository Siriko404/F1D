...
Loads Manager_QA_Negative_pct from Stage 2 linguistic variables output.
"""
...
class ManagerQANegativeBuilder(VariableBuilder):
    """Build Manager Q&A Negative Sentiment variable from Stage 2 outputs.
...
__all__ = ["ManagerQANegativeBuilder"]
