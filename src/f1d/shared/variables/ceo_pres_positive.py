"""Builder for CEO Presentation Positive Sentiment variable.

Loads CEO_Pres_Positive_pct from Stage 2 linguistic variables output.
"""
...
class CEOPresPositiveBuilder(VariableBuilder):
    """Build CEO Presentation Positive Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "CEO_Pres_Positive_pct")
...
__all__ = ["CEOPresPositiveBuilder"]
