"""Builder for Analyst Q&A Negative Sentiment variable.

Loads Analyst_QA_Negative_pct from Stage 2 linguistic variables output.
"""
...
class AnalystQANegativeBuilder(VariableBuilder):
    """Build Analyst Q&A Negative Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Analyst_QA_Negative_pct")
...
__all__ = ["AnalystQANegativeBuilder"]
