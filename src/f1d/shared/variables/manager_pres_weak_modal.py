...
Queries the shared LinguisticEngine for WModPreMgr.
...
class ManagerPresWeakModalBuilder(VariableBuilder):
    """Build Manager Presentation Weak Modal variable via LinguisticEngine.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "WModPreMgr")
