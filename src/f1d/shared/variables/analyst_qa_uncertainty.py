"""Builder for Analyst Q&A Uncertainty variable.

Loads Analyst_QA_Uncertainty_pct from Stage 2 linguistic variables output.
"""
...
class AnalystQAUncertaintyBuilder(VariableBuilder):
    """Build Analyst Q&A Uncertainty variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Analyst_QA_Uncertainty_pct")
...
__all__ = ["AnalystQAUncertaintyBuilder"]
