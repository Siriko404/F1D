...
Loads CEO_QA_Weak_Modal_pct from Stage 2 linguistic variables output.
"""
...
class CEOQAWeakModalBuilder(VariableBuilder):
    """Build CEO Q&A Weak Modal variable from Stage 2 outputs.
