"""Builder for Negative Sentiment variable.

Loads Entire_All_Negative_pct from Stage 2 linguistic variables output.
"""
...
class NegativeSentimentBuilder(VariableBuilder):
    """Build Negative Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Entire_All_Negative_pct")
...
__all__ = ["NegativeSentimentBuilder"]
