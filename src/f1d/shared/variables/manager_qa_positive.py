"""Builder for Manager Q&A Positive Sentiment variable.

Loads Manager_QA_Positive_pct from Stage 2 linguistic variables output.
"""
...
class ManagerQAPositiveBuilder(VariableBuilder):
    """Build Manager Q&A Positive Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Manager_QA_Positive_pct")
...
__all__ = ["ManagerQAPositiveBuilder"]
