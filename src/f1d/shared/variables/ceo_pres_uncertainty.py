...
Queries the shared LinguisticEngine for UncPreCEO.
...
class CEOPresUncertaintyBuilder(VariableBuilder):
    """Build CEO Presentation Uncertainty variable via LinguisticEngine.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "UncPreCEO")
