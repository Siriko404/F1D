"""Builder for Earnings Surprise Decile variable.

Loads SurpDec from Stage 3 firm controls output.
"""
...
class EarningsSurpriseBuilder(VariableBuilder):
    """Build Earnings Surprise Decile variable from Stage 3 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "SurpDec")
