"""Builder for CEO Q&A Negative Sentiment variable.

Loads CEO_QA_Negative_pct from Stage 2 linguistic variables output.
"""
...
class CEOQANegativeBuilder(VariableBuilder):
    """Build CEO Q&A Negative Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "CEO_QA_Negative_pct")
