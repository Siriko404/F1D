"""Builder for Entire Call Uncertainty variable.

Loads Entire_All_Uncertainty_pct from Stage 2 linguistic variables output.
"""
...
class EntireAllUncertaintyBuilder(VariableBuilder):
    """Build Entire Call Uncertainty variable from Stage 2 outputs.

    Source: outputs/2_Textual_Analysis/2.2_Variables/latest/
    File: linguistic_variables_{year}.parquet
    Column: Entire_All_Uncertainty_pct
    """

    def __init__(self, config: Dict[str, Any]):
        super().__init__(config)
        self.column = config.get("column", "Entire_All_Uncertainty_pct")
...
__all__ = ["EntireAllUncertaintyBuilder"]
