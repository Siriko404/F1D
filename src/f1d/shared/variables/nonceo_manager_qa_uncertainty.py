...
Loads NonCEO_Manager_QA_Uncertainty_pct from Stage 2 linguistic variables output.
"""
...
class NonCEOManagerQAUncertaintyBuilder(VariableBuilder):
    """Build Non-CEO Manager Q&A Uncertainty variable from Stage 2 outputs.
...
__all__ = ["NonCEOManagerQAUncertaintyBuilder"]
