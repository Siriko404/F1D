"""Builder for Analyst Q&A Positive Sentiment variable.

Loads Analyst_QA_Positive_pct from Stage 2 linguistic variables output.
"""
...
class AnalystQAPositiveBuilder(VariableBuilder):
    """Build Analyst Q&A Positive Sentiment variable from Stage 2 outputs.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "Analyst_QA_Positive_pct")
...
__all__ = ["AnalystQAPositiveBuilder"]
