...
Queries the shared LinguisticEngine for PosAnsNoCEO.
...
class NonCEOManagerQAPositiveBuilder(VariableBuilder):
    """Build Non-CEO Manager Q&A Positive Sentiment variable via LinguisticEngine.
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.column = config.get("column", "PosAnsNoCEO")
