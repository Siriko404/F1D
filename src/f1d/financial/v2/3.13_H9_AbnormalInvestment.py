...
"""
================================================================================
STEP 3.13: H9 Abnormal Investment (Biddle 2009)
================================================================================
ID: 3.13_H9_AbnormalInvestment
...
def generate_report(df, cell_diagnostics, regression_stats, output_dir, stats):
    ...
    report_path = output_dir / "report_step313_03.md"

    with open(report_path, "w") as f:
        f.write("# Step 313-03: H9 Abnormal Investment Construction Report\n\n")
...
def main() -> None:
    ...
    print("=" * 60)
    print("STEP 3.13: H9 Abnormal Investment (Biddle 2009)")
    print(f"Timestamp: {timestamp}")
    print("=" * 60)
    ...
    stats: Dict[str, Any] = {
        "step_id": "3.13_H9_AbnormalInvestment",
        "timestamp": timestamp,
