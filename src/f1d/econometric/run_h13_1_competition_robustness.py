...
MODERATORS = {
    "tsimm": {
        ...
        "interaction": "UncAnsCEO_c_x_zlogTSIMM",
        "label": "TNIC3TSIMM",
        "tex_label": r"$z(\log(\mathrm{TSIMM}))$",
        "tex_int_label": r"UncAnsCEO\_c $\times$ $z(\log(\mathrm{TSIMM}))$",
    },
}
...
# ------------------------------------------------------------------
SUITE_ID = "H13.1.r"
SUITE_DIR_NAME = "h13_1_competition_robustness"
SUITE_TITLE = "Product Similarity-Moderated Speech Uncertainty and Capital Expenditure (Orthogonal Speaker Partition: CEO Q&A)"
SUITE_CAPTION = (
    "H13.1.r: Product Similarity--Moderated Speech Uncertainty and Capital Expenditure "
    "(Robustness: CEO Q\\&A Speaker Partition)"
)
SUITE_LABEL = "tab:h13_1_robust"
...
def _save_latex_table(all_results: List[Dict[str, Any]], out_dir: Path) -> None:
    ...
    lines = [
        ...
        r"\label{tab:h13_1_capex_tnic_robust}",
        r"\small",
    ...
    tex_path = out_dir / "h13_1_capex_tnic_robustness_table.tex"
...
def _write_suite_spec_json(
    ...
    paths = write_suite_spec(
        ...
        ivs=[
            ...
            {"name": INTERACTION, "label": r"UncAnsCEO\_c\_x\_zlogTSIMM", "tail": "one_pos"},
        ],
        controls={
            "base": list(CONTROLS),
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h13_1_competition_robustness" / timestamp

    log_dir = setup_run_logging(
        log_base_dir=root / "logs",
        suite_name="H13_1_Competition_Robust",
        timestamp=timestamp,
    )
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics --- H13.1.r TNIC-Moderated Capex (Robustness, Main Sample)",
        label="tab:summary_stats_h13_1_robust",
    )
