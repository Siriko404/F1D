...
"""
================================================================================
STAGE 4: Test H5b Wang (2020) Analyst Dispersion Hypothesis
================================================================================
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Stage 4: H5b Wang (2020) Analyst Dispersion Test",
    )
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h5b_wang_disp" / timestamp

    setup_run_logging(log_base_dir=root / "logs", suite_name="H5b_WangDisp", timestamp=timestamp)

    print("=" * 80)
    print("STAGE 4: Test H5b Wang (2020) Analyst Dispersion Hypothesis")
    print("=" * 80)
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics — H5b Wang Dispersion (Main Sample)",
