...
# ------------------------------------------------------------------
SUITE_ID = "H1.1.r"
SUITE_DIR_NAME = "h1_1_cash_tsimm_robustness"
SUITE_TITLE = "Product Similarity-Moderated Speech Uncertainty and Cash Holdings (Orthogonal Speaker Partition: CEO Q&A)"
SUITE_CAPTION = (
    "H1.1.r: Product Similarity--Moderated Speech Uncertainty and Cash Holdings "
    "(Robustness: CEO Q\\&A Speaker Partition)"
)
SUITE_LABEL = "tab:h1_1_robust"
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h1_1_cash_tsimm_robustness" / timestamp

    log_dir = setup_run_logging(
        log_base_dir=root / "logs",
        suite_name="H1_1_CashTSIMM_Robust",
        timestamp=timestamp,
    )
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics --- H1.1.r TNIC-Moderated Cash Holdings (Robustness, Main Sample)",
        label="tab:summary_stats_h1_1_robust",
    )
