...
# ------------------------------------------------------------------
SUITE_ID = "H13.2.r"
SUITE_DIR_NAME = "h13_2_capex_leads_robustness"
SUITE_TITLE = "Speech Uncertainty and Capital Expenditure — Lead Horizons (Orthogonal Speaker Partition)"
SUITE_CAPTION = "H13.2 Robustness: Orthogonal Speaker Partition"
SUITE_LABEL = "tab:h13_2_robust"
...
def _save_latex_table(all_results: List[Dict[str, Any]], out_dir: Path) -> None:
    ...
    lines = [
        r"\begin{table}[htbp]",
        r"\centering",
        r"\caption{Speech Uncertainty and Capital Expenditure --- Lead Horizons (Orthogonal Speaker Partition)}",
        r"\label{tab:h13_2_robust}",
    ...
    tex_path = out_dir / "h13_2_capex_leads_robustness_table.tex"
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h13_2_capex_leads_robustness" / timestamp

    log_dir = setup_run_logging(
        log_base_dir=root / "logs",
        suite_name="H13_2_CapexLeads_robust",
        timestamp=timestamp,
    )
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics --- H13.2 Capex Lead Horizons Robustness (Main Sample)",
        label="tab:summary_stats_h13_2_robust",
    )
    ...
    if all_results:
        ...
        generate_attrition_table(attrition_stages, out_dir, "H13.2 Capex Lead Horizons Robustness")
