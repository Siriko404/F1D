...
def _save_latex_table(all_results: List[Dict[str, Any]], out_dir: Path) -> None:
    ...
    r_mw_1 = get_res_lag1("Manager_Clarity_Residual")
    r_cw_1 = get_res_lag1("CEO_Clarity_Residual")
    ...
    r_mw_2 = get_res_lag2("Manager_Clarity_Residual")
    r_cw_2 = get_res_lag2("CEO_Clarity_Residual")
