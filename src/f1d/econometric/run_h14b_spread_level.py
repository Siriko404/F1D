...
# ------------------------------------------------------------------
SUITE_ID = "H14b"
SUITE_DIR_NAME = "h14b_spread_level"
SUITE_TITLE = 'H14b: Speech Uncertainty and Lee (2016) 3-Day Post-Call Bid-Ask Spread Level ()'
SUITE_CAPTION = r'H14b: Speech Uncertainty and Lee (2016) 3-Day Post-Call Bid-Ask Spread Level ($[+1,+3]$)'
SUITE_LABEL = "tab:h14b"
