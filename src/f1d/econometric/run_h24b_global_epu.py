...
================================================================================
ID: econometric/run_h24b_global_epu
Description: Reverse-direction suite - aggregate Global Economic Policy
             Uncertainty (Davis 2016, NBER WP 22740; extends Baker, Bloom &
...
Outputs:
    - outputs/econometric/h24b_global_epu/{timestamp}/regression_results_col{1..8}.txt
...
SUITE_TITLE = "Global Economic Policy Uncertainty and Call Language Uncertainty"
SUITE_CAPTION = (
...
HYP_DIR = "positive"  # H24b: log(GEPU) -> higher speech uncertainty
...
def _save_latex_table(all_results: List[Dict[str, Any]], out_dir: Path) -> None:
    ...
    lines.extend(
        [
            ...
            r"Davis (2016, NBER WP 22740) Global Economic Policy "
            r"Uncertainty index (GDP-weighted average of 16 country EPU "
            r"indices), matched to each call by its calendar month. ",
...
def _write_suite_spec_json(
    ...
    """Emit canonical suite_spec.json for H24b (Global EPU macro suite).

    Same two-way clustering, two-row header, per-col control_vars pattern as
    H24/H25. See run_h24_us_epu.py for the annotated reference implementation.
    """
...
def main(panel_path: str | None = None) -> int:
    ...
    print("=" * 80)
    print(f"STAGE 4: {SUITE_ID} - {MACRO_IV} (Global EPU) -> Call Language Uncertainty")
    print("=" * 80)
