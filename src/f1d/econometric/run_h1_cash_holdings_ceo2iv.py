...
# ------------------------------------------------------------------
SUITE_ID = "H1.ceo2"
SUITE_DIR_NAME = "h1_cash_holdings_ceo2iv"
SUITE_TITLE = "Speech Uncertainty and Cash Holdings (CEO 2-IV: Q&A + Presentation)"
SUITE_CAPTION = r"H1 CEO 2-IV: CEO Q\&A + Presentation Uncertainty"
SUITE_LABEL = "tab:h1_ceo2"
...
def _save_latex_table(all_results: List[Dict[str, Any]], out_dir: Path) -> None:
    ...
    lines = [
        r"\begin{table}[htbp]",
        r"\centering",
        r"\caption{Speech Uncertainty and Cash Holdings (CEO 2-IV: Q\&A + Presentation)}",
        r"\label{tab:h1_ceo2}",
        r"\scriptsize",
    ...
    lines += [
        ...
        r"\textit{Notes:} ",
        r"CEO 2-IV variant of H1: restricts the joint-IV stack to exactly two CEO ",
        r"speech-uncertainty measures (UncAnsCEO Q\&A + UncPreCEO Presentation); ",
        r"drops all manager-pool and non-CEO manager measures. ",
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h1_cash_holdings_ceo2iv" / timestamp
