...
# ------------------------------------------------------------------
SUITE_ID = "H20b"
SUITE_DIR_NAME = "h20b_debt_choice"
SUITE_TITLE = "Speech Uncertainty and Debt vs Equity Choice (Chang et al. 2006)"
SUITE_CAPTION = (
    r"H20b: Speech Uncertainty and Debt vs Equity Choice (Chang et al. 2006)"
)
SUITE_LABEL = "tab:h20b"
...
def _save_latex_table(all_results: List[Dict[str, Any]], out_dir: Path) -> None:
    ...
    lines = [
        r"\begin{table}[htbp]",
        r"\centering",
        r"\caption{Speech Uncertainty and Debt vs Equity Choice (Chang et al. 2006)}",
        r"\label{tab:h20b_debt_choice}",
        r"\scriptsize",
    ...
    tex_path = out_dir / "h20b_debt_choice_table.tex"
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h20b_debt_choice" / timestamp

    log_dir = setup_run_logging(
        log_base_dir=root / "logs",
        suite_name="H20b_DebtChoice",
        timestamp=timestamp,
    )
    ...
    make_summary_stats_table(
        ...
        caption=r"Summary Statistics --- H20b Debt Choice (Chang et al. 2006) (External Funders, Main Sample)",
        label="tab:summary_stats_h20b",
    )
    ...
    if all_results:
        ...
        generate_attrition_table(attrition_stages, out_dir, "H20b Debt Choice (Chang)")
