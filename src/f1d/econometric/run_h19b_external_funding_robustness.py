...
# ------------------------------------------------------------------
SUITE_ID = "H19b.r"
SUITE_DIR_NAME = "h19b_external_funding_robustness"
SUITE_TITLE = "H19b: Speech Uncertainty (Orthogonal Speaker Partition)"
SUITE_CAPTION = (
    r"H19b Robustness: Orthogonal Speaker Partition"
)
SUITE_LABEL = "tab:h19b_robust"
...
def _save_latex_table(all_results: List[Dict[str, Any]], out_dir: Path) -> None:
    ...
    lines = [
        r"\begin{table}[htbp]",
        r"\centering",
        r"\caption{H19b Robustness: Orthogonal Speaker Partition}",
        r"\label{tab:h19b_robust}",
        r"\scriptsize",
    ...
    tex_path = out_dir / "h19b_external_funding_robustness_table.tex"
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h19b_external_funding_robustness" / timestamp

    log_dir = setup_run_logging(
        log_base_dir=root / "logs",
        suite_name="H19b_ExternalFunding_robust",
        timestamp=timestamp,
    )
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics --- H19b External Funding Robustness (Main Sample, Chang et al. 2006)",
        label="tab:summary_stats_h19b_robust",
    )
    ...
    if all_results:
        ...
        generate_attrition_table(attrition_stages, out_dir, "H19b External Funding (Chang) Robustness")
