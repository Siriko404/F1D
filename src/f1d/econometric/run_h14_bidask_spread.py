...
# ------------------------------------------------------------------
SUITE_ID = "H14"
SUITE_DIR_NAME = "h14_bidask_spread"
SUITE_TITLE = "Speech Uncertainty and Lee (2016) 3-Day Bid-Ask Spread Change (Delta-DSPREAD, [+1,+3]-[-3,-1])"
SUITE_CAPTION = (
    r"H14: Speech Uncertainty and Lee (2016) 3-Day Bid-Ask Spread Change "
    r"($\Delta$DSPREAD, $[+1,+3]-[-3,-1]$)"
)
SUITE_LABEL = "tab:h14"
...
def _save_latex_table(all_results, out_dir):
    ...
    lines = [
        ...
        r"\label{tab:h14_bidask_spread}", r"\scriptsize",
    ...
    with open(out_dir / "h14_bidask_spread_table.tex", "w", encoding="utf-8") as f:
        f.write("\n".join(lines))
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    log_dir = setup_run_logging(log_base_dir=root / "logs", suite_name="H14_BidAskSpread", timestamp=timestamp)
