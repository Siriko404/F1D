...
# ------------------------------------------------------------------
SUITE_ID = "H14d.r"
SUITE_DIR_NAME = "h14d_spread_bgt_delta_robustness"
SUITE_TITLE = 'H14d: Speech Uncertainty and Bid-Ask Spread (Orthogonal Speaker Partition)'
SUITE_CAPTION = r'H14d Robustness: Orthogonal Speaker Partition'
SUITE_LABEL = "tab:h14d_robust"
...
def _save_latex_table(all_results, out_dir):
    ...
    lines = [
        ...
        r"\caption{H14d Robustness: Orthogonal Speaker Partition}",
        r"\label{tab:h14d_robust}", r"\scriptsize",
    ...
    with open(out_dir / "h14d_spread_bgt_delta_robustness_table.tex", "w", encoding="utf-8") as f:
        f.write("\n".join(lines))
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h14d_spread_bgt_delta_robustness" / timestamp
    log_dir = setup_run_logging(log_base_dir=root / "logs", suite_name="H14d_BGTDelta_Spread_robust", timestamp=timestamp)
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics -- H14d BGTDelta_Spread Robustness (Main Sample)",
        label="tab:summary_stats_h14d_robust",
    )
    ...
    generate_manifest(
        ...
        output_files={"diagnostics": out_dir / "model_diagnostics.csv",
                      "table": out_dir / "h14d_spread_bgt_delta_robustness_table.tex"},
