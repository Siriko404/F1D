...
# ------------------------------------------------------------------
SUITE_ID = "H14e.r"
SUITE_DIR_NAME = "h14e_spread_bgt_avg_robustness"
SUITE_TITLE = 'H14e: Speech Uncertainty and Bid-Ask Spread (Orthogonal Speaker Partition)'
SUITE_CAPTION = r'H14e Robustness: Orthogonal Speaker Partition'
SUITE_LABEL = "tab:h14e_robust"
...
def _save_latex_table(all_results, out_dir):
    ...
    lines = [
        ...
        r"\caption{H14e Robustness: Orthogonal Speaker Partition}",
        r"\label{tab:h14e_robust}", r"\scriptsize",
    ...
    with open(out_dir / "h14e_spread_bgt_avg_robustness_table.tex", "w", encoding="utf-8") as f:
        f.write("\n".join(lines))
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h14e_spread_bgt_avg_robustness" / timestamp
    log_dir = setup_run_logging(log_base_dir=root / "logs", suite_name="H14e_BGTAvg_Spread_robust", timestamp=timestamp)
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics -- H14e BGTAvg_Spread Robustness (Main Sample)",
        label="tab:summary_stats_h14e_robust",
    )
    ...
    generate_manifest(
        ...
        output_files={"diagnostics": out_dir / "model_diagnostics.csv",
                      "table": out_dir / "h14e_spread_bgt_avg_robustness_table.tex"},
