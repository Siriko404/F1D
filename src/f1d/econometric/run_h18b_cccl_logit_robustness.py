...
# ------------------------------------------------------------------
SUITE_ID = "H18b.r"
SUITE_DIR_NAME = "h18b_cccl_logit_robustness"
SUITE_TITLE = "Logit Robustness --- Speech Uncertainty and SEC Comment Letters (Orthogonal Speaker Partition)"
SUITE_CAPTION = (
    "H18b.r: Logit + Orthogonal Speaker Partition --- SEC Comment Letters"
)
SUITE_LABEL = "tab:h18b_robust"
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h18b_cccl_logit_robustness" / timestamp

    log_dir = setup_run_logging(
        log_base_dir=root / "logs",
        suite_name="H18b_CCCL_Logit_robust",
        timestamp=timestamp,
    )
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics --- H18b CCCL Logit Robustness (Main Sample)",
        label="tab:summary_stats_h18b_robust",
    )
    ...
    if all_results:
        ...
        generate_attrition_table(attrition_stages, out_dir, "H18b CCCL Logit Robustness")
