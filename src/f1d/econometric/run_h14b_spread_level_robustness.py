...
# ------------------------------------------------------------------
SUITE_ID = "H14b.r"
SUITE_DIR_NAME = "h14b_spread_level_robustness"
SUITE_TITLE = 'H14b: Speech Uncertainty and Bid-Ask Spread (Orthogonal Speaker Partition)'
SUITE_CAPTION = r'H14b Robustness: Orthogonal Speaker Partition'
SUITE_LABEL = "tab:h14b_robust"
...
def _save_latex_table(all_results, out_dir):
    ...
    lines = [
        ...
        r"\label{tab:h14b_robust}", r"\scriptsize",
    ...
    with open(out_dir / "h14b_spread_level_robustness_table.tex", "w", encoding="utf-8") as f:
        f.write("\n".join(lines))
    print(f"  Saved: h14b_spread_level_robustness_table.tex")
...
def _write_suite_spec_json(
    ...
    """Emit canonical suite_spec_H14b.json from runner state."""
    ...
    header_rows = [
        [
            {"label": "PostCallSpread", "span": 6},
            {"label": r"PostCallSpread\_lead1", "span": 6},
        ]
    ]
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h14b_spread_level_robustness" / timestamp
    log_dir = setup_run_logging(log_base_dir=root / "logs", suite_name="H14b_Spread_Level_robust", timestamp=timestamp)
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics -- H14b Spread Level Robustness (Main Sample)",
        label="tab:summary_stats_h14b_robust",
    )
