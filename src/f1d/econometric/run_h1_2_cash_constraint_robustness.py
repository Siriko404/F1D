...
# ------------------------------------------------------------------
SUITE_ID = "H1.2.r"
SUITE_DIR_NAME = "h1_2_cash_constraint_robustness"
SUITE_TITLE = (
    "Financial Constraint-Moderated Speech Uncertainty and Cash Holdings "
    "(Three-Category, Orthogonal Speaker Partition: CEO Q&A)"
)
SUITE_CAPTION = (
    "H1.2.r: Financial Constraint--Moderated Speech Uncertainty and Cash Holdings "
    "(Three-Category, Robustness: CEO Q\\&A Speaker Partition)"
)
SUITE_LABEL = "tab:h1_2_robust"
...
def main(panel_path: Optional[str] = None) -> int:
    ...
    out_dir = root / "outputs" / "econometric" / "h1_2_cash_constraint_robustness" / timestamp

    log_dir = setup_run_logging(
        log_base_dir=root / "logs",
        suite_name="H1_2_CashConstraint_Robust",
        timestamp=timestamp,
    )
    ...
    make_summary_stats_table(
        ...
        caption="Summary Statistics --- H1.2.r Cash Holdings (3-Category Constraint, Robustness, Main Sample, 2002--2016)",
        label="tab:summary_stats_h1_2_robust",
    )
