...
"""
================================================================================
STAGE 3: Build H11 Political Risk - Language Uncertainty Panel
================================================================================
ID: variables/build_h11_prisk_uncertainty_panel
Description: Build CALL-LEVEL panel for H11 Political Risk hypothesis test.
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Stage 3: Build H11 Political Risk Uncertainty Panel",
...
def save_outputs(panel: pd.DataFrame, stats: Dict[str, Any], out_dir: Path, root: Path, timestamp: str) -> None:
    ...
    panel_path = out_dir / "h11_prisk_uncertainty_panel.parquet"
    panel.to_parquet(panel_path, index=False)
    print(
        f"\n  Saved: h11_prisk_uncertainty_panel.parquet ({len(panel):,} rows, {len(panel.columns)} columns)"
    )
...
def generate_report(
    ...
    report_lines = [
        "# Stage 3: H11 Political Risk - Language Uncertainty Panel Build Report",
        "",
    ...
    report_path = out_dir / "report_step3_h11.md"
...
def main(year_start: Optional[int] = None, year_end: Optional[int] = None) -> int:
    ...
    stats: Dict[str, Any] = {
        "step_id": "build_h11_prisk_uncertainty_panel",
        "timestamp": timestamp,
        "variable_stats": [],
        "timing": {},
        "panel": {},
    ...
    out_dir = root / "outputs" / "variables" / "h11_prisk_uncertainty" / timestamp
    ...
    print("=" * 80)
    print("STAGE 3: Build H11 Political Risk - Language Uncertainty Panel")
    print("=" * 80)
