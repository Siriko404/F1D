...
Table~\ref{tab:h1_ceo2_decomp} reports the main estimation results for cash holdings on the speech-uncertainty independent variables of interest. Across the twelve specifications, UncResCEO loads positively on cash holdings in every cell, with one-tailed p-values below the ten-percent level. UncPreCEO is positive but statistically indistinguishable from zero across all twelve specifications.
