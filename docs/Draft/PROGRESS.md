...
**Current phase:** **Phase 5 audit — philosophy-framed, dialogue-based. 15 / 37 suites audited (Q1 COMPLETE + RE-CATALOGUED + Q2 batch 1 COMPLETE). Q1: H1 + H4a + H4b + H12 + H12b + H13 + H17 + H19b KEEP; H16 DROP-flagged; H20b DROP. Q2 batch 1 (H1.1/H1.1b/H1.2/H13.1/H13.2): all 5 KEEP. Notable Q2 findings: H1 family TSIMM moderation null (H1.1/H1.1b), Unrated × UncAnsMgr_c sig 4/4 (H1.2), capex × TSIMM sig 8/8 incl firm-FE (H13.1), UncAnsMgr persistent 10/16 across 4 capex horizons (H13.2). Rules 21-24 added 2026-04-15. §5.13 explains H1 vs H1.1 sample gap as CEO coverage bottleneck (not panel drift). Next = H22 (Q2 batch 2, last Q2 suite).**

**Last updated:** 2026-04-15 (post-Q2 batch 1 + §5.13 CEO coverage explanation)
...
- [ ] **Phase 5 audit/synthesis — IN PROGRESS.** Philosophy + design finalized 2026-04-14. **15 / 37 suites audited — Q1 COMPLETE + RE-CATALOGUED + Q2 batch 1 COMPLETE.** Q1: H1 + H4a + H4b + H12 + H12b + H13 + H17 + H19b KEEP; **H16 DROP-flagged**; **H20b DROP**. Q2 batch 1: H1.1 + H1.1b + H1.2 + H13.1 + H13.2 all KEEP. **Rules 21-24 added 2026-04-15** (r21: provisional Q is placeholder; r22: null signs are noise; r23: sig-pattern is the signal not magnitudes; **r24: read/verdict/record three scopes — record broader than verdict; every variable catalogued in §4.2; Q1 retroactive REVERSED same day, all 10 Q1 blocks re-catalogued**). **Q2 notable findings**: H1 family TSIMM moderation null (H1.1/H1.1b), **Unrated × UncAnsMgr_c 4/4 sig** (H1.2 — only sig H1-family interaction), **capex × TSIMM 8/8 sig incl firm-FE** (H13.1 — strongest moderation in audit), UncAnsMgr persistent 10/16 across 4 capex horizons (H13.2). See `docs/Draft/DECISIONS.md §4.1/§4.2` (all 15 records), §5.1-5.13 (cross-cutting flags: §5.12 Q1 re-catalogue methodology shift, **§5.13 CEO coverage gap explains H1 vs H1.1 sample difference as 4-IV complete-case bottleneck, NOT panel drift**). Tracker: `memory/project_phase5_audit_progress.md`. Reference: `memory/reference_ceo_coverage_gap.md`. **Next cluster: Q2 batch 2 = H22 (last Q2 suite, firm-year ~4-8K N).**
