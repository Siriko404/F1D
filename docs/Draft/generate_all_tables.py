...
def main() -> int:
    ...
    include_lines: list[str] = [
        ...
        r"% Master include for all 37 suite tables (pdflscape landscape envelope).",
        r"% \input this file from main.tex to wire all regression tables.",
        r"% No \clearpage between fragments — pdflscape's \begin{landscape}",
        r"% already issues \clearpage at start AND end of each landscape block.",
    ]
