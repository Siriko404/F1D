...
- ABSTRACT CITATIONS: the abstract carries NO \\citet/\\citep at all. Name the measure descriptively ("a residual measure of CEO question-and-answer uncertainty"); the DWZ decomposition and all author names are cited in the Introduction and Section 2, never in the abstract.
- DIFFERENTIATE FOUR NEAR-NEIGHBOR PARAGRAPHS (do NOT restate one in another): the intro gap (1-P3) = what is MISSING; the intro significance (1-P2) = why it MATTERS; the intro contributions (1-P7) = what we ADD; the conclusion implications (5-P4) = what it MEANS now. Each states its own angle ONCE. Specifically: (a) 1-P3 and 1-P7 must not both spell out "prior work read tone/vocabulary/prices, not uncertainty language" -- the gap states it, the contribution refers back without re-listing; (b) 1-P2 and 1-P7 must not both develop the "distinct from the price channel" point; (c) 1-P7 and 5-P4 must not both narrate the "withholding meets transaction-anticipation" literature bridge -- the intro frames it as a contribution, the conclusion as a matured implication. Cross-reference or compress; never echo.
- NOVELTY CONSISTENCY: the contributions (1-P7) read at the SAME "to our knowledge" confidence as the gap (1-P3 / IN.6); keep contribution one ATTACHED to "the nearest prior work" and NEVER harden it to "we are the first to" (the everhart/gokkaya scar). The gap and the contributions must read as one consistent confidence level about the same empty cell, not two.
...
7. Coherence + NO REDUNDANCY: the paragraphs flow as one unit; the abstract is a faithful compression of the intro; the conclusion mirrors the intro's setup without re-opening it; no contradiction across the three units. SPECIFICALLY flag any echo among the four near-neighbor paragraphs: gap (1-P3 = what's missing) vs contributions (1-P7 = what we add) both spelling out "tone/vocabulary/prices not uncertainty language"; significance (1-P2 = why it matters) vs contributions (1-P7) both on the "distinct from prices" point; intro contributions (1-P7) vs conclusion implications (5-P4 = what it means now) both narrating the withholding-meets-anticipation bridge. Each angle appears ONCE; the others cross-reference or compress.
