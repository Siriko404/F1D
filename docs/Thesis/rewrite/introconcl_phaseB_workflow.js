...
6. ${R}/tmp/nlm_*.json + ${R}/docs/Thesis/rewrite/NLM_QUERY_GUIDE.md -- the external-literature receipts + the rule that NLM is the SOLE paper authority. Keep every external-NLM prop tied to its receipt; carry forward any "needs NLM verification" open_decision from Phase A.
