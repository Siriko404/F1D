...
try:
    from 2_Scripts.shared.subprocess_validation import validate_script_path
...
@pytest.mark.skipif(not SUBPROCESS_VALIDATION_AVAILABLE, reason="subprocess_validation module not available")
