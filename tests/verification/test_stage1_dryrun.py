...
Stage 1 Scripts (sample/):
    - build_sample_manifest.py (orchestrator)
    - clean_metadata.py
    - link_entities.py
    - build_tenure_map.py
...
# Stage 1 sample scripts to test (excluding utility modules and __init__.py)
STAGE1_SCRIPTS = [
...
class TestStage1SequentialDependencies:
    ...
    def test_script_order(self):
        ...
        expected_order = [
            "build_sample_manifest",  # Orchestrator
            "clean_metadata",
            "link_entities",
            "build_tenure_map",
            "assemble_manifest",
