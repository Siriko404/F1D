...
Plans:
- [x] 27-01-PLAN.md — Add get_latest_output_dir() to shared/path_utils.py, update dependency_checker and data_loading (Wave 1)
- [x] 27-02-PLAN.md — Update Step 1-2 reader scripts to use timestamp-based resolution (Wave 2)
- [x] 27-03-PLAN.md — Update Step 3 and Step 4.1.x reader scripts (Wave 2)
- [x] 27-04-PLAN.md — Update remaining Step 4 scripts and test files (Wave 2)
- [x] 27-05-PLAN.md — Remove symlink creation from all 20 pipeline scripts (Wave 3)
- [x] 27-06-PLAN.md — Delete symlink_utils.py and clean up duplicate utilities (Wave 4)
...
| 27. Remove Symlink Mechanism | 6/6 | ✅ COMPLETED | 2026-01-30 |
...
*Roadmap updated: 2026-01-30 (Phase 27 complete - all 143 plans finished, 100% complete)*
*Total plans: 143 (143 completed, 0 planned)*
